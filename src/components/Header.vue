<template>
  <header id="header">
    <div class="header-container">
      <div class="header-breadcrumb">Nathan Louie</div>
      ...
      <nav class="header-nav">
        ...
        <ul>
          ...
          <li class="social-link">
            <a
              href="mailto:nathanhlouie@gmail.com"
              target="_blank"
              title="Email"
            >
              <svg
                ...
                viewBox="0 0 16 16"
                role="img"
                aria-labelledby="EmailIcoTitle"
              >
                <title id="EmailIcoTitle">Email</title>
                <path
          ...
          <li class="social-link">
            <a
              href="https://www.linkedin.com/in/nathan-louie-b279b1209/"
              target="_blank"
              title="LinkedIn"
            >
              <svg
